...
class Aparelho(models.Model):
    ...
    modelo_anatomico = models.CharField(
        max_length=10,
        choices=MODELO_ANATOMICO_CHOICES
    )

    perda_indicada = models.CharField(
        max_length=20,
        choices=NIVEL_PERDA_CHOICES
    )
    ...
    candidato_escolhido = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='aparelhos_recebidos'
    )
